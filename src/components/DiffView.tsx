...
export function DiffView({ diff, summary }: DiffViewProps) {
    ...
    return (
        <div className="mt-4 space-y-4">
            {/* Diff Output */}
            <div className="rounded-lg border border-zinc-800 bg-zinc-950 p-4 w-full">
                <div
                ...
                >
                    ...
                    <svg
                        className={`h-4 w-4 text-zinc-500 transition-transform ${isDiffExpanded ? 'rotate-180' : ''}`}
                ...
                {isDiffExpanded && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 overflow-x-auto">
                        {/* Previous Version */}
